...
//      .build
    ...
    result1.toDataSet[(String,Long)].writeAsCsv("/result/result1.txt",fieldDelimiter = "|",writeMode = WriteMode.OVERWRITE).setParallelism(1)
    //result 2
    ...
    result2.toDataSet[(String,Long)].writeAsCsv("/result/result2.txt",fieldDelimiter = "|",writeMode = WriteMode.OVERWRITE).setParallelism(1)
    ...
    result4.toDataSet[(String,Long)].writeAsCsv("/result/result4.txt",fieldDelimiter = "|",writeMode = WriteMode.OVERWRITE).setParallelism(1)
    ...
    result5.toDataSet[Row].writeAsText("/result/result5.txt",writeMode = WriteMode.OVERWRITE).setParallelism(1)
